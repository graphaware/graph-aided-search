...
public class CypherHttpEndPoint extends CypherEndPoint {
    ...
    public CypherResult executeCypher(String cypherQuery, Map<String, Object> parameters) {
        ...
        return executeCypher(headers, cypherQuery, parameters);
    }

    public CypherResult executeCypher(Map<String, String> headers, String query, Map<String, Object> parameters) {
    ...
    public Map<String, Object> post(String url, Map<String, String> headers, String json) {
        if (!headers.containsKey(HttpHeaders.AUTHORIZATION) && null != neo4jPassword) {
            headers.put(HttpHeaders.AUTHORIZATION, UrlUtil.getAuthorizationHeaderValue(neo4jUser, neo4jPassword));
        }
